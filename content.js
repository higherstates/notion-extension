...
function addCopyButtonForBoardView() {
	...
	boardColumns.forEach((column) => {
		...
		tasks.forEach((task) => {
			...
			if (!task.querySelector(".custom-copy-on-board-icon")) {
				...
				if (taskIdNode) {
					...
					if (taskId.startsWith("TK-")) {
						...
						if (link) {
							...
							copyIconContainer.className = "custom-copy-on-board-icon";
